...
preamble-tier: 4
version: 1.0.0
description: Pre-landing PR review (local shadow of gstack/review, renamed because Claude Code built-in /review shadows it). (gstack)
allowed-tools:
  - Bash
  - Read
  - Edit
...
Read `.claude/skills/pre-land-review/checklist.md`.
...
Read `.claude/skills/pre-land-review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps.
