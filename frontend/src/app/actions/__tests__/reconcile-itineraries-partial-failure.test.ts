 ...
 * @brief reconcileAndAdvanceItineraries partial-failure 测试增强（[026] T18 A1.8 增强）
 *
 ...
 *   `@/app/actions/timebox/mutation-service` 的 `createItineraryMutationService`
...
// `createItineraryMutationService`。在文件顶层 vi.mock 此模块、注入受控 execute
...
vi.mock('@/app/actions/timebox/mutation-service', () => ({
  createItineraryMutationService: () => ({
...
describe('reconcileAndAdvanceItineraries partial-failure（T18 增强）', () => {
  beforeEach(async () => {
